...
* @{
*/
#define PRODUCT_KEY "17abceee79bc4ea7a95dcfcf4037096a"
/**@} */
/**@name Product Secret (Product key)
* @{
*/
#define PRODUCT_SECRET "2c98f569da284c90852f2bac45926764"
...
* @{
*/
#define switch_led_BYTEOFFSET                    0
#define switch_led_BITOFFSET                     0
#define switch_led_LEN                           1
#define switch_relay_BYTEOFFSET                    0
#define switch_relay_BITOFFSET                     1
#define switch_relay_LEN                           1
#define LED_Color_BYTEOFFSET                    0
#define LED_Color_BITOFFSET                     2
#define LED_Color_LEN                           4
...
typedef struct {
  bool valueswitch_led;
  bool valueswitch_relay;
...
typedef struct {
  uint8_t flagswitch_led:1;
  uint8_t flagswitch_relay:1;
